...
import { ChevronDown, Mail, Phone, MapPin, Facebook, Instagram, Linkedin } from "lucide-react";
  ...
  return (
    <div className="min-h-screen font-sans text-slate-600">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-r from-primary to-primary/80">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-lg text-slate-200">We're here to help you with any questions or concerns about our insurance services.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <Input type="email" placeholder="your@email.com" className="h-12 rounded-lg" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-primary mb-2">Phone Number</label>
                  <Input placeholder="+91 XXXXXXXXXX" className="h-12 rounded-lg" />
                </div>
                ...
                <div>
                  ...
                  <textarea placeholder="Your message..." className="w-full h-32 px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:border-secondary resize-none"></textarea>
                </div>
            ...
            {/* Contact Details */}
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="text-3xl font-heading font-bold text-primary mb-8">Contact Details</h2>
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">contact@insurancelab.com</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">123 Insurance Blvd, Financial District, New York, NY 10005</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 p-6 rounded-2xl">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex justify-between"><span>Monday - Friday</span> <span className="font-bold">09:00 - 18:00</span></li>
                  <li className="flex justify-between"><span>Saturday</span> <span className="font-bold">10:00 - 16:00</span></li>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-3">
                  <button onClick={() => window.open("https://facebook.com", "_blank")} className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                    <Facebook size={18} />
                  </button>
                  <button onClick={() => window.open("https://instagram.com", "_blank")} className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                    <Instagram size={18} />
                  </button>
                  <button onClick={() => window.open("https://linkedin.com", "_blank")} className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                    <Linkedin size={18} />
                  </button>
                </div>
              </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-5xl font-heading font-bold text-primary text-center mb-16">Our Services</h2>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { title: "Personal Insurance", desc: "Individual coverage for all life stages" },
              { title: "Business Insurance", desc: "Enterprise-level protection and advisory" },
              { title: "Investments & Loans", desc: "Financial guidance and loan assistance" },
              { title: "Claim Services", desc: "Fast and efficient claim processing" }
            ].map((service, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
