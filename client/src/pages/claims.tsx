...
import claimsHeroImg from "@assets/generated_images/claimservicecopy.jpg";

const whatsappUrl =
  "https://wa.me/917303177489?text=Hello%20Insurance%20Lab,%20I%20need%20help%20with%20a%20claim.";
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-200 mb-8 max-w-xl">
                We understand that claims often arise during challenging times.
            ...
            >
              <img
                ...
                onError={(e) =>
                  (e.currentTarget.src =
                    "https://images.unsplash.com/photo-1556740758-90de2742e234?auto=format&fit=crop&q=80&w=1000")
                }
              />
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: Clock,
                title: "Fast Intimation",
                desc: "24–48h coordination with insurers",
              },
              {
                icon: UserCheck,
                title: "Dedicated Handler",
                desc: "Single point of contact till settlement",
              },
              {
                icon: MessageCircle,
                title: "Clear Updates",
                desc: "Proactive communication at each step",
              },
              {
                icon: HeartHandshake,
                title: "Fair Outcomes",
                desc: "Guidance to maximise eligible payout",
              },
              {
                icon: HeadphonesIcon,
                title: "24/7 Support",
                desc: "Help anytime you need it",
              },
              {
                icon: FileText,
                title: "Paperwork Review",
                desc: "Pre-check your documents",
              },
              {
                icon: ShieldCheck,
                title: "Personalised Support",
                desc: "Support tailored to your policy",
              },
              {
                icon: CheckCircle2,
                title: "Cashless Assistance",
                desc: "Help with network garages",
              },
            ].map((feature, i) => (
              <motion.div
                key={i}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              A clear, step-by-step path — from incident to settlement.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Tell us what happened and share required documents. We'll validate and organise them for you.",
                },
                {
                  step: "2",
                  title: "File & Coordinate",
                  desc: "We file the claim with the insurer and coordinate surveys, assessments, and queries.",
                },
                {
                  step: "3",
                  title: "Settle & Support",
                  desc: "We follow through until settlement — keeping you informed and supported at every step.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="bg-white p-8 rounded-2xl shadow-lg border-2 border-slate-100 text-center relative group hover:border-secondary transition-colors"
                >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`inline-block px-3 py-1 rounded-full text-xs font-bold mb-4 ${item.color} border`}
                >
                  {item.category}
                </div>
