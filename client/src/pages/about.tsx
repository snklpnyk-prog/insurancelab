  ...
  return (
    <div className="min-h-screen font-sans text-slate-600">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">About Insurance Lab</h1>
            <p className="text-xl text-slate-200 mb-8">Your trusted partner in comprehensive insurance solutions and financial protection.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <img src={aboutImg} alt="Our Team" className="w-full h-full object-cover" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-heading font-bold text-primary mb-6">Our Story</h2>
              <p className="text-slate-600 text-lg mb-4 leading-relaxed">
                Founded on the principle that insurance should be simple, transparent, and truly protective, Insurance Lab emerged from a vision to revolutionize the insurance industry.
              </p>
              <p className="text-slate-600 text-lg mb-4 leading-relaxed">
                Our founder, Anshul Purohit, spent years studying risk management and insurance patterns. He realized that most people felt overwhelmed and confused by insurance policies. This sparked the creation of Insurance Lab—a company dedicated to turning uncertainty into confidence.
              </p>
              <p className="text-slate-600 text-lg mb-6 leading-relaxed">
                Today, we serve over 25,000 satisfied customers with a 98% satisfaction rate, providing scientific risk assessment and tailored protection plans for families and businesses across India.
              </p>
              <Button 
                className="bg-primary hover:bg-primary/90 text-white px-8 py-6 rounded-full font-bold"
              >
                Our Mission
              </Button>
            </motion.div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-heading font-bold text-primary mb-4">Our Mission & Values</h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-heading font-bold text-primary mb-4">Our Leadership Team</h2>
            <div className="w-20 h-1 bg-secondary mx-auto rounded-full"></div>
          </div>

          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { name: "Anshul Purohit", role: "Founder & CEO", bio: "20+ years of insurance expertise" },
              { name: "Priya Singh", role: "Chief Operations Officer", bio: "Expert in claim management and customer service" },
              { name: "Rahul Sharma", role: "Chief Financial Officer", bio: "Financial advisor and risk analyst" }
            ].map((member, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-heading font-bold mb-4">Our Achievements</h2>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center"
              >
                <div className="text-5xl font-heading font-bold text-secondary mb-2">{stat.number}</div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-4xl font-heading font-bold text-primary mb-16 text-center">Why Choose Insurance Lab?</h2>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { title: "Scientific Approach", desc: "We use data-driven models to assess risk accurately." },
              { title: "Transparent Pricing", desc: "No hidden charges. You know exactly what you're paying for." },
              { title: "24/7 Support", desc: "Our team is always available to assist you." },
              { title: "Fast Claims", desc: "Settle claims within 24-48 hours, not weeks." },
              { title: "Customized Plans", desc: "Every policy is tailored to your specific needs." },
              { title: "Expert Advisors", desc: "Work with certified insurance professionals." }
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-4xl font-heading font-bold mb-6">Ready to Protect Your Future?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">Join thousands of satisfied customers who trust Insurance Lab for their protection.</p>
          <Button 
